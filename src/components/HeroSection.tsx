        ...
        ><Spotlight
            ...
            <div className="p-4 relative z-10 w-full text-center" >
                ...
                >Dive into our comprehensive music courses and transform your musical journey today.
                    Whether you're a beginner or looking to refine your skills, join us to unlock your true potential.</p>

                <div className='mt-4'>
                    <Link href={"/courses"}>
                        <Button borderRadius="1.75rem"
                            className=" dark:bg-black text-black dark:text-white border-neutral-200 dark:border-slate-900">
